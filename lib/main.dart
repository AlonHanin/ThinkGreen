    ...
    DevicePreview(
      ...
      builder: (context) => MultiProvider(
        providers: [
          ...
          ChangeNotifierProxyProvider2<ActivityApiService, SessionProvider, ActivityProvider>(
            create: (context) => ActivityProvider(apiService: context.read<ActivityApiService>()),
          ...
          ChangeNotifierProxyProvider2<ChallengeApiService, SessionProvider, ChallengeProvider>(
            create: (context) => ChallengeProvider(apiService: context.read<ChallengeApiService>()),
            update: (_, apiService, sessionProvider, previous) {
              final provider = previous ?? ChallengeProvider(apiService: apiService);
              provider.bindSession(sessionProvider);
              return provider;
            },
          ),
          ChangeNotifierProxyProvider4<RewardApiService, SessionProvider, ActivityProvider, ChallengeProvider, RewardProvider>(
            create: (context) => RewardProvider(apiService: context.read<RewardApiService>()),
            update: (_, apiService, sessionProvider, activityProvider, challengeProvider, previous) {
