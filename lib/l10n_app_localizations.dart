...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _translations = {
    'he': {
      ...
      'Add your actions manually with photo verification':
          'הוסף פעולות ידנית עם אימות תמונה',
      'Green Activity History': 'היסטוריית פעילויות ירוקות',
      'See approved, pending and rejected reports':
          'צפה בדיווחים מאושרים, ממתינים ונדחים',
      'Sync External Apps': 'סנכרון אפליקציות חיצוניות',
      'Prepare automatic tracking from services like STRAVA':
          'הכן מעקב אוטומטי משירותים כמו STRAVA',
      ...
      'Reports that cannot be verified automatically will wait for admin review.':
          'דיווחים שלא ניתן לאמת אוטומטית ימתינו לאישור מנהל.',
      'Please select an activity and take a photo first.':
          'בחר פעילות וצלם תמונה לפני ההגשה.',
      'Image data is missing. Please try taking the photo again.':
          'נתוני התמונה חסרים. נסה לצלם שוב.',
      'AI verification matched your report. Points were added immediately.':
          'האימות האוטומטי תאם את הדיווח שלך. הנקודות נוספו מיד.',
      'Your report was submitted successfully and is waiting for admin review.':
          'הדיווח נשלח בהצלחה וממתין לבדיקת מנהל.',
      'Awesome!': 'מעולה!',
      ...
      'Complete tasks to earn big points!':
          'השלם משימות כדי לצבור הרבה נקודות!',
      ...
      'Use a reusable bottle or skip plastic bags for 7 actions.':
          'השתמש בבקבוק רב־פעמי או ותר על שקיות פלסטיק במשך 7 פעולות.',
      'Public Transport Streak': 'רצף תחבורה ציבורית',
      'Choose buses or public transport 5 times this week.':
          'בחר באוטובוס או בתחבורה ציבורית 5 פעמים השבוע.',
      ...
      'Use a reusable bottle instead of disposable plastic.':
          'השתמש בבקבוק רב־פעמי במקום פלסטיק חד־פעמי.',
      ...
      'Custom eco challenge.': 'אתגר ירוק מותאם אישית.',
      'Target': 'יעד',
      ...
      'Use your points to get rewards and benefits':
          'נצל את הנקודות שלך כדי לקבל פרסים והטבות',
      ...
      'Rewards you redeemed but have not used yet':
          'פרסים שמימשת ועדיין לא השתמשת בהם',
      ...
      'Redeem': 'מימוש',
      'Locked': 'נעול',
      'No active rewards yet. Redeem a reward first to generate a QR code.':
          'עדיין אין פרסים פעילים. ממש קודם פרס כדי לייצר קוד QR.',
      ...
      'Keep this screen open until the business scans your code. Enjoy your reward!':
          'השאר את המסך פתוח עד שבית העסק יסרוק את הקוד שלך. תהנה מהפרס!',
      ...
      'Single-use 10% discount on one purchase.':
          'הנחה חד־פעמית של 10% על רכישה אחת.',
      ...
      'Convert your points into a sponsored tree planting.':
          'המר את הנקודות שלך לנטיעת עץ ממומנת.',
      ...
      'Discounts, tote bags, eco accessories':
          'הנחות, תיקי בד ואביזרים אקולוגיים',
      'Fresh produce discounts': 'הנחות על תוצרת טרייה',
      'Free drink upgrades and pastry deals':
          'שדרוגי שתייה חינם ומבצעים על מאפים',
      ...
      'Enter the email linked to your Think Green account. We will verify you with a short security PIN before letting you create a new password.':
          'הזן את האימייל שמחובר לחשבון Think Green שלך. נאמת אותך בעזרת קוד PIN קצר לפני יצירת סיסמה חדשה.',
      ...
      'Choose a strong password with at least 6 characters.':
          'בחר סיסמה חזקה עם לפחות 6 תווים.',
      'New Password': 'סיסמה חדשה',
      'Change Password': 'שנה סיסמה',
      'Password Updated': 'הסיסמה עודכנה',
      'Your password was changed successfully. Please sign in with your new password.':
          'הסיסמה שונתה בהצלחה. התחבר עם הסיסמה החדשה שלך.',
      'Back to Login': 'חזרה להתחברות',
      'Password reset session expired. Start again from Forgot Password.':
          'סשן איפוס הסיסמה פג. התחל שוב ממסך שכחתי סיסמה.',
      ...
      'This email does not match any existing account.':
          'האימייל הזה לא תואם לשום חשבון קיים.',
      ...
      'Integration disabled for now (Coming Soon)':
          'החיבור הזה כבוי כרגע (בקרוב)',
      'Sync Services': 'סנכרון שירותים',
      'Automate Your\nPoints': 'אוטומציה של\nהנקודות שלך',
      'Connect your favorite apps to track eco-actions automatically.':
          'חבר את האפליקציות האהובות עליך כדי לעקוב אוטומטית אחרי פעולות ירוקות.',
      'CONNECT': 'חבר',
      'Connected': 'מחובר',
      ...
      'Your Strava activities were synced successfully.':
          'פעילויות Strava שלך סונכרנו בהצלחה.',
      'PUBLIC TRANSPORT': 'תחבורה ציבורית',
      'MOOVIT': 'MOOVIT',
      'Track Your Public Transport Trips': 'מעקב אחרי נסיעות בתחבורה ציבורית',
      'Upload a Moovit screenshot, ticket, or route proof.':
          'העלה צילום מסך ממוביט, כרטיס נסיעה או הוכחת מסלול.',
      'Open Manual Report and choose Used Public Transport to earn points.':
          'פתח דיווח ידני ובחר השתמשתי בתחבורה ציבורית כדי לקבל נקודות.',
      ...
      'No activities yet. Submit your first green action to start earning points.':
          'עדיין אין פעילויות. שלח את הפעולה הירוקה הראשונה שלך כדי להתחיל לצבור נקודות.',
      ...
      'Not enough points to redeem this reward yet.':
          'עדיין אין לך מספיק נקודות למימוש הפרס הזה.',
      ...
      'Select date of birth': 'בחר תאריך לידה',
      'Full name must contain at least 2 characters.':
          'השם המלא חייב להכיל לפחות 2 תווים.',
    },
  };
  ...
  String languageLabel(Locale locale) =>
      locale.languageCode == 'he' ? raw('Hebrew') : raw('English');

  String daysLeft(int days) =>
      isHebrew ? 'נותרו $days ימים' : '$days days left';
  ...
  String availablePointsLabel(int points) =>
      isHebrew ? 'נקודות זמינות: $points' : 'Available points: $points';

  String nextRewardAt(int points) =>
      isHebrew ? 'הפרס הבא ב־$points נקודות' : 'Next reward at: $points points';

  String codeLabel(String code) => isHebrew ? 'קוד: $code' : 'Code: $code';

  String showQrAt(String partnerName) =>
      isHebrew
          ? 'הצג את קוד ה-QR הזה ב־$partnerName'
          : 'Show this QR code at $partnerName';

  String rewardsLabel(String rewards) =>
      isHebrew ? 'הטבות: $rewards' : 'Rewards: $rewards';

  String redeemedPointsPartner(int points, String partnerName) =>
      isHebrew ? '$points נק׳ • $partnerName' : '$points Points • $partnerName';

  String redeemedOn(String value) =>
      isHebrew ? 'מומש $value' : 'Redeemed $value';

  String submittedOn(String value) =>
      isHebrew ? 'נשלח: $value' : 'Submitted: $value';

  String endsOn(DateTime date) =>
      isHebrew
          ? 'מסתיים ב: ${date.day}/${date.month}/${date.year}'
          : 'Ends on: ${date.day}/${date.month}/${date.year}';

  String languageUpdated(Locale locale) =>
      isHebrew
          ? 'השפה עודכנה ל${languageLabel(locale)}.'
          : 'Language updated to ${languageLabel(locale)}.';

  String comingSoon([String? feature]) {
    final label = feature == null ? raw('This feature') : raw(feature);
    return isHebrew
        ? '$label יחובר בשלב הבא.'
        : '$label will be connected in the next phase.';
  }

  String analysisFailed(Object error) =>
      isHebrew
          ? 'האימות נכשל. הדיווח לא נשלח. שגיאה: $error'
          : 'Analysis failed. The report was not submitted. Error: $error';

  String securityPinSentTo(String email) =>
      isHebrew
          ? 'הזן את קוד האימות שנשלח ל־$email.'
          : 'Enter the verification PIN sent to $email.';

  String welcomeBackUser(String name) =>
      isHebrew ? 'היי, ברוך שובך – $name' : 'Hi, Welcome Back – $name';

  String welcomeBackFirstName(String firstName) =>
      isHebrew ? 'ברוך שובך $firstName!' : 'Welcome back $firstName!';

  String challengeRewardUnlocked(int points) =>
      isHebrew
          ? 'השלמת את האתגר וקיבלת $points נקודות בונוס.'
          : 'You completed the challenge and earned $points bonus points.';

  String challengeProgress(int current, int target) => '$current/$target';

  String challengeButtonLabel(bool isCompleted) =>
      isCompleted ? raw('Completed') : raw('Go To Activities');
