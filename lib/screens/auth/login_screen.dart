    ...
    showDialog<void>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(context.tr('Sign in with an admin account to continue.')),
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              if (!sessionProvider.isAdmin) {
                ...
                final message = context.tr('This account does not have admin access.');
            ...
            child: Text(context.tr('LOGIN'), style: const TextStyle(color: Colors.white)),
          ),
        ],
      ),
    );
