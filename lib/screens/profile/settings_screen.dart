    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          _buildSectionTitle(context, context.tr('Privacy')),
          _buildSwitchTile(
            context,
    ...
    return Padding(
      ...
      child: Text(
        ...
        style: GoogleFonts.outfit(
          fontSize: 16,
          fontWeight: FontWeight.bold,
          color: isDark ? const Color(0xFF8FE3A2) : const Color(0xFF1B5E20),
        ),
      ),
    );
  }
                  ...
                  [const Locale('en'), const Locale('he')]
                      .map(
                        (locale) => ListTile(
                          ...
                          trailing:
                              sessionProvider.locale.languageCode ==
                                      locale.languageCode
                                  ? const Icon(
                                    Icons.check,
                          ...
                          onTap: () {
                            ...
                            showAppSnackBar(
                              context,
                              context.loc.languageUpdated(locale),
                            );
                          },
                        ),
                      )
